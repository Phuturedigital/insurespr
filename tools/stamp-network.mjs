...
const CONCEPTS = [
  ...
  { key: 'ibhuku',    name: 'Ibhuku',               sector: 'Informal-trade bookkeeping', url: 'https://ibhuku-concept.phuturedigital.co.za' },
];
...
const SITES = [
  ...
  { key: 'ibhuku', dir: 'ibhuku',
    mark: '<strong>Concept demo.</strong> Ibhuku is an invented brand, created by Phuture Digital to demonstrate design and build work. There is no company and no product to sign up for, and every price and figure in its demo is an illustration.' },
];
